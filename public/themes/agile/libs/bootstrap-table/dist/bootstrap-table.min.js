...
!(function (a) {
    ...
    var d = {
            ...
            4: {
                ...
                toobarDropdowItemHtml:
                    '<label class="dropdown-item">%s</label>',
        ...
        k = function (b, c, d) {
            ...
            for (var i = 0; i < f.length; i++)
                if (((h = f[i]), a.inArray(h, g) > -1 && b[h] !== c[h]))
                    return !1;
            return !0;
        },
        l = function (a) {
    ...
    (q.DEFAULTS = {
        ...
        (q.EVENTS = {
            ...
            "reset-view.bs.table": "onresetValues",
                        ...
                        a.each(g, function (a, e) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    (b.header.formatters[e.fieldIndex] =
                                        e.formatter),
                                    (b.header.events[e.fieldIndex] = e.events),
                                    (b.header.sorters[e.fieldIndex] = e.sorter),
                                    (b.header.sortNames[e.fieldIndex] =
                                        e.sortName),
                                    (b.header.cellStyles[e.fieldIndex] =
                                        e.cellStyle),
                                    (b.header.searchables[e.fieldIndex] =
                                        e.searchable),
                                    !e.visible)
                                )
                                    return;
                ...
                : void (
                      ...
                      this.data.sort(function (f, g) {
                          ...
                          var h = n(f, c, b.options.escape),
                              ...
                              k = j(b.header, b.header.sorters[e], [
                                  h,
                                  i,
                                  f,
                                  g,
                    ...
                    : ((this.options.sortName = c.data("field")),
                      (this.options.sortOrder = this.options.rememberOrder
                          ? "asc" === c.data("order")
                              ...
                              : "asc"
                          : this.columns[
                                this.fieldsColumnsIndex[c.data("field")]
                            ].order)),
                this.trigger(
                    "sort",
                    this.options.sortName,
                    ...
                    var p =
                        "string" == typeof this.options.pageList
                            ? this.options.pageList
                                  ...
                                  .split(",")
                            : this.options.pageList;
                    a.inArray(this.options.formatAllRows().toLowerCase(), p) >
                        -1 && (m = !0);
                }
                (this.totalPages =
                ...
                if ("string" == typeof this.options.pageList) {
                    ...
                    (o = []),
                        a.each(r, function (a, b) {
                            o.push(
                                b.toUpperCase() ===
                                    k.options.formatAllRows().toUpperCase() ||
        ...
        (q.prototype.initRow = function (b, c) {
            ...
            if (!(a.inArray(b, this.hiddenRows) > -1)) {
                if (
                    ((i = j(this.options, this.options.rowStyle, [b, c], i)),
                    i && i.css)
                )
                    for (d in i.css) k.push(d + ": " + i.css[d]);
                if (
                    (o = j(this.options, this.options.rowAttributes, [b, c], o))
                )
                ...
                return (
                    ...
                    h.push(
                        ...
                        f(
                            ' class="%s"',
                            i.classes || (a.isArray(b) ? void 0 : b._class)
                        ),
                        f(' data-index="%s"', c),
                    ...
                    a.each(this.header.fields, function (d, m) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                (i = f(
                                    'style="%s"',
                                    k.concat(e.header.styles[d]).join("; ")
                                )),
                                b["_" + m + "_id"] &&
                                    (t = f(' id="%s"', b["_" + m + "_id"])),
                                b["_" + m + "_class"] &&
                                ...
                                i = f(
                                    'style="%s"',
                                    A.concat(e.header.styles[d]).join("; ")
                                );
                            }
        ...
        (q.prototype.initBody = function (b) {
            ...
            for (
                var e,
                    g = a(document.createDocumentFragment()),
                    h = this.pageFrom - 1;
                h < this.pageTo;
                h++
            ) {
                ...
                this.$body
                    ...
                    .on("click dblclick", function (b) {
                        var d = a(this),
                            ...
                            j =
                                i[
                                    c.options.detailView && !c.options.cardView
                                        ? h - 1
                                        : h
                                ],
                        ...
                        if (
                            ...
                            var m = e.find(
                                f('[name="%s"]', c.options.selectItemName)
                            );
                            m.length && m[0].click();
                        }
                    }),
        ...
        (q.prototype.fitHeader = function () {
            var b,
                ...
                g = this;
            if (g.$el.is(":hidden"))
                return void (g.timeoutId_ = setTimeout(
                    a.proxy(g.fitHeader, g),
                    100
                ));
            if (
        ...
        (q.prototype.resetValues = function (a) {
            var b = 0;
            if (
        ...
        (q.prototype.refreshColumnTitle = function (b) {
            if (
                ...
                ((this.columns[this.fieldsColumnsIndex[b.field]].title = this
                    .options.escape
                    ? l(b.title)
                    : b.title),
