...
class TestController extends Controller
{
    ...
    private function balance()
    {
        ...
        $result = json_decode(jengaFetchBalance($account));
    ...
    private function mini_statement()
    {
        ...
        echo jengaGetMiniStatement($account);
    ...
    {
        $account = Account::where("id", 7)->first();
        echo jengaGetFullStatement($account, '2022-01-01', date('Y-m-d'), 20);
    ...
    private function send_to_equity()
    {
        ...
        $result = jengaSendToEquity($account, $destination);
        info($result);
        echo $result;
    ...
    private function send_to_mpesa()
    {
        ...
        $result = jengaSendToMobile($account, $destination);
        info($result);
        echo $result;
    }
    ...
    private function rtgs()
    {
        ...
        $result = jengaSendRtgs($account, $destination);
        info($result);
        echo $result;
    ...
    private function swift()
    {
        ...
        $result = jengaSendSwift($account, $destination);
        info($result);
        echo $result;
        //{"status":true,"code":0,"message":"success","reference":"DIOL692194625798","data":{"transactionId":"DIOL692194625798","status":"SUCCESS"}}
    }
    ...
    private function pesalink_bank()
    {
        ...
        $account = Account::with(["currency"])->where("id", 2)->first();
        $result = jengaPesalinkBank($account, $destination);
        info($result);
        echo $result;
    }
    ...
    private function pesalink_mobile()
    {
        ...
        $account = Account::with(["currency"])->where("id", 2)->first();
        $result = jengaPesalinkMobile($account, $destination);
        info($result);
        echo $result;
