            ...
            if ($transaction) {
                ...
                if ($result) {
                    ...
                    if (!$transaction->save()) {
                        ...
                        log_transaction($transaction->account->id, TransactionType::TYPE_PAYMENTS, $transaction->service->client_id, $transaction->service_id, floor($transaction->disbursed_amount), $result_status, $result->message, $transaction->order_number . ' - ' . $transaction->account_number, $transaction->requested_by);
